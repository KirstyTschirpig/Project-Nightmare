...
namespace Generation.Nodes
{
    ...
    abstract public class CallableActionNode : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            var o = node.AddGenerationOutput(" ");
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2, T3> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value, p3.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2, T3, T4> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value, p3.value, p4.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2, T3, T4, T5> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value, p3.value, p4.value, p5.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6, T7> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6, T7, T8> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value, p8.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6, T7, T8, T9> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value, p8.value, p9.value); o.Call(f); });
        }
    }
    ...
    abstract public class CallableActionNode<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : CallableActionNodeBase
    {
        ...
        sealed protected override void OnRegisterPorts(GenerationNode node) {
            ...
            node.AddGenerationInput(" ", (GenerationFlow f) => { Invoke(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value, p8.value, p9.value, p10.value); o.Call(f); });
        }
    }
}