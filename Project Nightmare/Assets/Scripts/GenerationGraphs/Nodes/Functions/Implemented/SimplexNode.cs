...
namespace Generation.Nodes
{
    ...
    abstract public class SimplexNode
    {
        ...
        protected GenerationNode parentNode { get; private set; }
        ...
        public void RegisterPorts(GenerationNode node) {
        ...
        public void SetDefaultParameters(GenerationNode node) {
            if ( parameters == null ) {
                return;
            }
        ...
        abstract protected void OnRegisterPorts(GenerationNode node);
        virtual protected void OnRegisterExtraPorts(GenerationNode node) { }
