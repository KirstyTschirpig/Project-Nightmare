...
namespace Generation.Graphs
{
    ...
    public class BinderConnection : Connection
    {
        ...
        public Port sourcePort {
            ...
            {
                if ( _sourcePort == null ) {
                    if ( sourceNode is GenerationNode ) { //In case it's 'MissingNode'
                        _sourcePort = ( sourceNode as GenerationNode ).GetOutputPort(_sourcePortID);
                    }
                }
                return _sourcePort;
            }
        ...
        public Port targetPort {
            ...
            {
                if ( _targetPort == null ) {
                    if ( targetNode is GenerationNode ) { //In case it's 'MissingNode'
                        _targetPort = ( targetNode as GenerationNode ).GetInputPort(_targetPortID);
                    }
                }
                return _targetPort;
            }
        ...
        public System.Type bindingType {
            get { return GetType().RTIsGenericType() ? GetType().RTGetGenericArguments()[0] : typeof(GenerationFlow); }
        }
        ...
        virtual public void UnBind() {
            if ( sourcePort is GenerationOutput ) {
                ( sourcePort as GenerationOutput ).UnBind();
            }
        }
        ...
        public override Color defaultColor {
            get { return bindingType == typeof(GenerationFlow) ? base.defaultColor : Color.grey; }
        }

        public override float defaultSize {
            get { return bindingType == typeof(GenerationFlow) ? 4 : base.defaultSize; }
        }
        ...
        protected void BlinkStatus(GenerationFlow f = default(GenerationFlow)) {
            if ( Application.isPlaying ) {
        ...
        IEnumerator MonitorBlink(GenerationFlow f) {
