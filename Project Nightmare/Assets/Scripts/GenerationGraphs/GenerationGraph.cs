...
namespace Generation.Graphs
{
    ...
    [System.Serializable]
    abstract public class GenerationGraph : Graph
    {
        ...
        public override System.Type baseNodeType { get { return typeof(GenerationNode); } }
        ...
        protected override void OnGraphStarted() {
            ...
            if ( !hasInitialized ) {
                ...
                for ( var i = 0; i < allNodes.Count; i++ ) {
                    if ( allNodes[i] is GenerationNode ) {
                        var flowNode = (GenerationNode)allNodes[i];
        ...
        protected override UnityEditor.GenericMenu OnCanvasContextMenu(UnityEditor.GenericMenu menu, Vector2 mousePos) {
            return GenerationGraphExtensions.GetFullNodesMenu(this, mousePos, null, null);
        }
        ...
        protected override UnityEditor.GenericMenu OnNodesContextMenu(UnityEditor.GenericMenu menu, Node[] nodes) {
            menu.AddItem(new GUIContent("Convert To Macro"), false, () => { GenerationGraphExtensions.ConvertNodesToMacro(nodes.ToList()); });
            return menu;
        }
        ...
        protected override void OnGraphEditorToolbar() {
            if ( GUILayout.Button(new GUIContent(NodeCanvas.Editor.StyleSheet.verboseLevel1, "Minimize All/Selected"), UnityEditor.EditorStyles.toolbarButton, GUILayout.MaxHeight(12)) ) {
                foreach ( var node in NodeCanvas.Editor.GraphEditorUtility.GetSelectedOrAll(this).OfType<GenerationNode>() ) {
