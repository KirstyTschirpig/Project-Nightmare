...
using ParadoxNotion;
using UnityEngine;
using TypeConverter = Generation.Graphs.TypeConverter;
...
namespace Generation.Graphs
{
    ...
    abstract public class Port
    {
        ...
        public Port() { }
        public Port(GenerationNode parent, string name, string ID) {
            this.parent = parent;
            this.name = name;
            this.ID = ID;
        }
        ...
        public GenerationNode parent { get; private set; }
        ...
        public bool IsOutputPort() {
            return ( this is GenerationOutput ) || ( this is ValueOutput );
        }
    ...
    public class GenerationInput : Port
    {
        ...
        public GenerationFlowHandler pointer { get; private set; }
        ///The type of the port which is always type of Flow
        public override Type type { get { return typeof(GenerationFlow); } }
    }

    ///Output port for Flow type
    public class GenerationOutput : Port
    {

        public GenerationOutput(GenerationNode parent, string name, string ID) : base(parent, name, ID) { }
        ...
        public void Call(GenerationFlow f) {
        ...
        System.Collections.IEnumerator DebugBreakWait(GenerationFlow f) {
        ...
        void Continue(GenerationFlow f) {
            try { pointer(f); }
            catch ( Exception e ) {
                var connection = GetFirstOutputConnection();
                var targetNode = (GenerationNode)connection.targetNode;
                targetNode.Error(e);
            }
        }
#endif
        ...
        public void Append(GenerationFlowHandler action) {
            this.pointer += action;
        }
    ...
    abstract public class ValueInput : Port
    {
        ...
        public ValueInput() { }
        public ValueInput(GenerationNode parent, string name, string ID) : base(parent, name, ID) { }

        ///Creates a generic instance of ValueInput
        public static ValueInput<T> CreateInstance<T>(GenerationNode parent, string name, string ID) {
            return new ValueInput<T>(parent, name, ID);
        }

        ///Creates a generic instance of ValueInput
        public static ValueInput CreateInstance(Type t, GenerationNode parent, string name, string ID) {
            ...
            get
            {
                if ( getter != null ) {
                    ...
                    try { return getter(); }
                        ...
                        var targetNode = (GenerationNode)connection.sourceNode;
                        targetNode.Error(e);
                    }
    ...
    abstract public class ValueOutput : Port
    {
        ...
        public ValueOutput() { }
        public ValueOutput(GenerationNode parent, string name, string ID) : base(parent, name, ID) { }

        ///Creates a generic instance of ValueOutput
        public static ValueOutput<T> CreateInstance<T>(GenerationNode parent, string name, string ID, ValueHandler<T> getter) {
            return new ValueOutput<T>(parent, name, ID, getter);
        }

        ///Creates a generic instance of ValueOutput
        public static ValueOutput CreateInstance(Type t, GenerationNode parent, string name, string ID, ValueHandlerObject getter) {
    ...
    public class ValueOutput<T> : ValueOutput
    {
        ...
        //normal
        public ValueOutput(GenerationNode parent, string name, string ID, ValueHandler<T> getter) : base(parent, name, ID) {
            this.getter = getter;
        }

        //casted
        public ValueOutput(GenerationNode parent, string name, string ID, ValueHandlerObject getter) : base(parent, name, ID) {
