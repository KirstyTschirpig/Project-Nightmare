...
namespace Generation.Graphs.Macros
{
    ...
    [ProtectedSingleton]
    public class MacroInputNode : GenerationNode
    {
        ...
        protected override void RegisterPorts() {
            ...
            for ( var i = 0; i < macro.inputDefinitions.Count; i++ ) {
                ...
                if ( def.type == typeof(GenerationFlow) ) {
                    macro.entryActionMap[def.ID] = AddGenerationOutput(def.name, def.ID).Call;
                } else {
        ...
        protected override void OnNodeInspectorGUI() {
            ...
            if ( GUILayout.Button("Add Flow Input") ) {
                macro.AddInputDefinition(new DynamicPortDefinition("Flow Input", typeof(GenerationFlow)));
            }
            ...
            EditorUtils.ReorderableList(macro.inputDefinitions, options, (i, picked) =>
            {
                ...
                GUI.enabled = def.type != typeof(GenerationFlow);
