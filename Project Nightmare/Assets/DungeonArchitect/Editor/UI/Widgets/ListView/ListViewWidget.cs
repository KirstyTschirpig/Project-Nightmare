...
namespace DungeonArchitect.Editors.UI.Widgets
{
    ...
    public class ListViewWidget<T> : WidgetBase
    {
        ...
        public override void UpdateWidget(WidgetContext context, Rect bounds)
        {
            ...
            layout.UpdateWidget(context, layoutBounds);
        }
        ...
        public override void Draw(WidgetContext context)
        {
            ...
            EditorGUI.DrawRect(bounds, new Color(0.1f, 0.1f, 0.1f));

            WidgetUtils.DrawWidgetGroup(context, layout);
        ...
        public void SetSelectedItem(T item, bool selectOnInspector)
        {
            var items = dataSource.GetItems();
    ...
    public class ListViewTextItemWidget : WidgetBase, IListViewItemWidget
    {
        ...
        public override void Draw(WidgetContext context)
        {
            ...
            if (Selected)
            {
                EditorGUI.DrawRect(bounds, SelectedColor);
            }
        ...
        public virtual void DrawText(Rect bounds)
        {
        ...
        protected override void HandleDragStart(Event e, WidgetContext context)
        {
            var bounds = new Rect(Vector2.zero, WidgetBounds.size);
            if (bounds.Contains(e.mousePosition))
            {
                base.HandleDragStart(e, context);
            }
        }
