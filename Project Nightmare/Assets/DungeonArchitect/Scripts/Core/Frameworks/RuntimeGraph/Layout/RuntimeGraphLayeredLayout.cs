...
namespace DungeonArchitect.RuntimeGraphs.Layouts
{
    ...
    {
        public RuntimeGraphNode<T> GraphNode;
        public float X;
        public int Depth;
        public float Mod;
    ...
    [System.Serializable]
    public class RuntimeGraphLayeredLayoutConfig
    {
        public RuntimeGraphLayeredLayoutConfig(Vector2 separation) {
    ...
    public class RuntimeGraphLayeredLayout<T> : IRuntimeGraphLayout<T>
    {
        RuntimeGraphLayeredLayoutConfig config;
        public RuntimeGraphLayeredLayout(RuntimeGraphLayeredLayoutConfig config)
        {
            this.config = config;
        }

        LayoutTreeNode<T> BuildTreeNode(LayoutTree<T> tree, LayoutTreeNode<T> parent, RuntimeGraphNode<T> graphNode, HashSet<RuntimeGraphNode<T>> visited)
        {
        ...
        LayoutTree<T> BuildTree(RuntimeGraph<T> graph)
        {
            ...
            {
                var visited = new HashSet<RuntimeGraphNode<T>>();
        ...
        public void Layout(RuntimeGraph<T> graph)
        {
